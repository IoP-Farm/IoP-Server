...
namespace farm::sensors
{
    ...
    {
    private:
        // Пины, к которым подключен датчик
        uint8_t trigPin;
        uint8_t echoPin;
    ...
    public:
        ...
        // Считать уровень воды в см
        float read() override;
        
        // Считать расстояние до поверхности в сантиметрах (без преобразования в проценты)
        float readDistance();
